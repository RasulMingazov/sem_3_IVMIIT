...
//        add();
        /*
        в) по полученному в п б) файлу провести потоковое чтение и вывести на экран
        список только имен авторов (использовать Streaming API какого-либо парсера,
        без полного чтения всей структуры json)
         */
//        streamReading();
    }
